    ...
    <div class="container is-max-desktop">
        <div class="columns">
            <div class="column is-3">
                ...
                <aside class="menu">
                    ...
                    <ul class="menu-list">
                        ...
                        <li><a class="my-user-btn active" href="mycollection.php">My Collection</a></li>
            ...
            <div class="column">
                ...
                <div class="columns my-subtitle">
                    <div class="column">
                        <h3 class="title-font">My Collection</h3>
                        <hr class="line1">
                    </div>
                </div>
                ...
                <nav class="pagination is-rounded is-small" role="navigation" aria-label="pagination">
                    <a class="pagination-previous my-pag-btn">Previous</a>
                    <a class="pagination-next my-pag-btn">Next page</a>
                    <ul class="pagination-list">
                        <li><a class="pagination-link my-pag-link" aria-label="Goto page 1">1</a></li>
                        <li><span class="pagination-ellipsis">&hellip;</span></li>
                        <li><a class="pagination-link my-pag-link" aria-label="Goto page 45">45</a></li>
                        <li><a class="pagination-link my-pag-active" aria-label="Page 46" aria-current="page">46</a>
                        </li>
                        <li><a class="pagination-link my-pag-link" aria-label="Goto page 47">47</a></li>
                        <li><span class="pagination-ellipsis">&hellip;</span></li>
                        <li><a class="pagination-link my-pag-link" aria-label="Goto page 86">86</a></li>
                    </ul>
                </nav>
                -->
